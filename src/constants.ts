...
export const BRIDGE_CALL_GAS_LIMIT_INCREASE_PERCENTAGE = 50; // 20%

export const BRIDGE_CALL_PERMIT_GAS_LIMIT_INCREASE = 1000000;

export const GAS_PRICE_INCREASE_PERCENTAGE = 200; // 50%
